...
import {MockERC20JankySpaghetti002} from "./utils/mocks/MockERC20JankySpaghetti002.sol";

import {CREATE3} from "../utils/CREATE3.sol";

contract CREATE3_002_Test is DSTestPlus {
    function testDeployERC20JankySpaghetti() public {
        bytes32 salt = keccak256(bytes("A salt!"));

        MockERC20JankySpaghetti002 deployed = MockERC20JankySpaghetti002(
            CREATE3.deploy(
                salt,
                abi.encodePacked(
                    type(MockERC20JankySpaghetti002).creationCode,
